...
var AdminStatusesList = createReactClass({
    ...
    prepareModal: function () {
        if (this.state.modalIsActive == true) {
            return <AdminStatusDetails fields={this.state.modalData.fields} name={this.state.modalData.name} _id={this.state.modalData._id} isFinal={this.state.modalData.isFinal} finishModal={this.finishModal}/>
        }
    },
